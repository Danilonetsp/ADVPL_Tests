...
oFont := TFont():New('Verdana',,-12,.T.)
 ...
 oSay:= TSay():Create(oDlg,{||'Texto para exibição'},01,01,,oFont,,,,.T.,CLR_RED,CLR_WHITE,200,20)
 oSay2:= TSay():Create(oDlg,{||'Texto para exibição'},15,01,,oFont,,,,.T.,CLR_RED,CLR_WHITE,200,20)
 // Métodos
 oSay:CtrlRefresh()
 oSay:SetText( "Nome:" )
 oSay2:CtrlRefresh()
